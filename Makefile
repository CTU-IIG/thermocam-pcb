...
LDFLAGS = -L/$(WIC_HOME)/lib -L/$(EBUS_HOME)/lib -Wl,-rpath-link=$(EBUS_HOME)/lib -Wl,-rpath-link=$(EBUS_HOME)/lib/genicam/bin/Linux64_x64
...
$(PROG):$(SRCS)
	$(CC) $(CFLAGS) -o $(PROG) $(SRCS) $(LDFLAGS) $(LDFLAGS_EXTRA) $(LIBS)
